...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = 'GhostHaunt'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = 'GhostHaunt é o lugar perfeito para os amantes de filmes de ação, terror, ficção científica e muito mais!'
...
thumb_icon_config = 'https://archive.org/download/definicoes/definicoes.png'
desc_configuracoes = '[B][COLOR white]CONFIGURAÇÕES DO ADDON[/COLOR][/B]'
## FAVORITOS
...
dialog_playlist = 'Selecione um Conteudo'
...
url_principal = 'https://painel-ghost.vercel.app/index.xml'
    ...
    try:
        ...
        if exists == True:
            ...
            if fcheck and fcheck.read() == '1' and check_addon == 'true':
                #print('valor 1')
                fcheck.close()
                link = getRequest2('https://ghosthauntcomplements.vercel.app/verificar_addons_matrix.txt','').replace('\n','').replace('\r','')
...
def install_wizard(name,addon_id,url,directory,description):
    try:
        ...
        notify(name+' Instalado com Sucesso, Renicie Seu Kodi!')
        import database
